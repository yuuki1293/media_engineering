...
{	
    ...
    x_off   = num_of_data/2;  y_off   = num_of_data/2;
...
//             printf("max data %lf\n",da);
            if ( (MAX_BRIGHTNESS+da-damax) < 0 )              image[2][y+y_off][x+x_off] = 0;
//            else if ( da > MAX_BRIGHTNESS ) 
//                       image3[y+y_off][x+x_off] = MAX_BRIGHTNESS;
            else           image[2][y+y_off][x+x_off] = (unsigned char)(MAX_BRIGHTNESS+da-damax);
